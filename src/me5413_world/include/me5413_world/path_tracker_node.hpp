...
private:
  ...
  geometry_msgs::Pose findLookaheadPoint(const nav_msgs::Path::ConstPtr& path);
  geometry_msgs::Twist computeControlOutputs(const nav_msgs::Odometry& odom_robot, const geometry_msgs::Pose& lookahead_point);
  ...
  // Constants
  static constexpr double K_PURE_PURSUIT = 15.0;
};
